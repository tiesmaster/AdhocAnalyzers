...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(AdhocRefactoringsCodeRefactoringProvider)), Shared]
    internal class AdhocRefactoringsCodeRefactoringProvider : CodeRefactoringProvider
    {
